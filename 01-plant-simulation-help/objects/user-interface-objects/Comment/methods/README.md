...
This document summarizes the methods available for the **Comment** object in Plant Simulation.

> Source files in this directory: `methods.md` (and `methods.txtx`, which contains the same content in plain-text form). There are no subfolders.
...
- The [Methods of All Objects](https://example.invalid).
