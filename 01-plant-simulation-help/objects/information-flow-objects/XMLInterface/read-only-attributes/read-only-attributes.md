...
Returns the number of attributes of the active node of the XMLInterface designated by `<Path>`.

### Remarks

`GetNumberAttributes` applies when you randomly traverse data.
...
## Attributes of the XML Interface
