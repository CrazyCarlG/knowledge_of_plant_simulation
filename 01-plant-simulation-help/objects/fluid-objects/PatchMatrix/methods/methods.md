...
Returns the numbers of the successors of the PatchMatrix designated by `<Path>` for which a connection from the predecessor exists.

- **Type:** Method
- **Syntax:** `<Path>.getConnectionsForPred(Pred:integer) → array`
- **Parameter:** The parameter `Pred` of data type integer designates the number of the predecessor.
- **Return Value:** The return value has the data type array.
...
**See also:** Connections [PatchMatrix], getConnectionsForPred [SimTalk], getConnectionsForSucc [SimTalk], setConnections [SimTalk]

---

## getConnectionsForSucc [SimTalk]

Returns the numbers of the predecessor of the PatchMatrix designated by `<Path>` for which a connection to the successor exists.

- **Type:** Method
- **Syntax:** `<Path>.getConnectionsForSucc(Succ:integer) → array`
- **Parameter:** The parameter `Succ` of data type integer designates the number of the successor.
- **Return Value:** The return value has the data type array.
...
**See also:** Connections [PatchMatrix], getConnectionsForSucc [SimTalk], getConnectionsForPred [SimTalk], setConnections [SimTalk]

---

## resetConnections [SimTalk]

Resets the existing connections of the PatchMatrix designated by `<Path>` to their predecessors and successors, i.e. it cuts the connections.

- **Type:** Method
- **Syntax:** `<Path>.resetConnections`
...
**See also:** Connections [PatchMatrix], resetConnections [SimTalk], setConnections [SimTalk]

---

## setConnections [SimTalk]

Establishes the connections between the predecessors and the successors of the PatchMatrix designated by `<Path>` (connect is true) or it cuts the connection (connect is false).

- **Type:** Method
- **Syntax:** `<Path>.setConnections(Pred:any, Succ:any, connect:boolean) → array`

**Parameters**

You can specify the following parameters:

- The parameter `Pred` of data type any designates the predecessor(s).
  The parameter `Pred` can either be the number of the predecessor, the name of the predecessor, or an array of predecessor numbers.
- The parameter `Succ` of data type any designates the successor(s).
  The parameter `Succ` can either be the number of the successor, the name of the successor, or an array of successor numbers.
- The parameter `connect` of data type boolean sets if the Pipes are going to be connected (true) or not (false).
...
**See also:** Connections [PatchMatrix], setConnections [SimTalk], getConnectionsForPred [SimTalk], getConnectionsForSucc [SimTalk], resetConnections [SimTalk]
...
The PatchMatrix provides the methods, read-only attributes, and attributes listed in the table of contents to the left.
