...
- The _Methods for Defining Failures.
- The _Methods of the Importer.

The sub-chapters about the objects list additional methods for the fluid objects.

To view all of the methods, read-only attributes, and attributes of an object, open the window **Show Attributes and Methods**. The figure below illustrates the information using the example of the object Station.
