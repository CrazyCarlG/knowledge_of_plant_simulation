...
See also: Edit 3D Properties [dialog] > Appearance of Objects and MUs, Appearance of the Length-oriented Objects, Appearance of the Store.
...
**Remarks:** Also sets if the MU designated by `<MU-Path>` has an object-wide material (`true`) or not (`false`).
...
**See also:** Edit 3D Properties [dialog] > Appearance of Objects and MUs > Material Active [check box] - MUs
...
**Remarks:** Also sets the ambient color of the graphic of the MU designated by `<MU-Path>`.

**Note:** When assigning a value to the attribute, we automatically set the material to active (`MaterialActive := true`).
...
**Assignment Value:** You can assign a value of data type integer. You will usually set the color with the method `makeRGBValue` [SimTalk].
...
**See also:** Edit 3D Properties [dialog] > Appearance of Objects and MUs > Ambient Color [MUs]
...
**Remarks:** Also sets the diffuse color of the graphic of the MU designated by `<MU-Path>`.
...
**See also:** Edit 3D Properties [dialog] > Appearance of Objects and MUs > Diffuse Color [MUs]
...
**Remarks:** Also sets the emissive color of the graphic of the MU designated by `<MU-Path>`.
...
**See also:** Edit 3D Properties [dialog] > Appearance of Objects and MUs > Emissive Color [MUs]
...
**Remarks:** Also sets the shininess of the graphic of the MU designated by `<MU-Path>`.
...
**Assignment Value:** You can assign a value of data type real between 0 and 1.
...
**See also:** Edit 3D Properties [dialog] > Appearance of Objects and MUs > Shininess [MUs]
...
**Remarks:** Also sets the specular color of the graphic of the MU designated by `<MU-Path>`.
...
**See also:** Edit 3D Properties [dialog] > Appearance of Objects and MUs > Specular Color [MUs]
...
**Remarks:** Also sets the transparency of the graphic of the MU designated by `<MU-Path>`.
...
**See also:** Edit 3D Properties [dialog] > Appearance of Objects and MUs > Transparency [MUs]
...
**See also:** Edit 3D Properties [dialog] > Appearance of Objects and MUs > Show Safety Zones, Length Zone 1, ΔWidth Zone 1, Length Zone 2, ΔWidth Zone 2
...
See also: Edit 3D Properties [dialog] > Appearance of the Store.
...
**Assignment Value:** You can assign an array of data type length with three values. They designate the X-dimension/width, the Y-dimension/depth, and the Z-dimension/height of the storage area.
...
**See also:** Edit 3D Properties [dialog] > Store > X [text box] - Store, Y [text box] - Store, Z [text box] - Store
...
**Remarks:** Also sets the Thickness of the individual shelves of the Store designated by `<Path>` for the Store Type > Rack with round/square posts (dynamic).
...
**Assignment Value:** You can assign a value of data type any. Specify `void` to use the default thickness.
...
**See also:** `_3D.StoreType` [SimTalk], Edit 3D Properties [dialog] > Appearance of the Store > Floor Thickness, Edit 3D Properties [dialog] > Appearance of the Store > Board Thickness
...
**Note:** The attribute only applies to the dynamic store types. For a dynamic rack, Plant Simulation implicitly uses a gap of 3 cm. For a dynamic floor space, Plant Simulation uses an effective gap of 0 cm which also includes the borderline.
...
**Assignment Value:** You can assign a value of data type any. You can only assign a value greater than or equal to 0. Specify `void` to use no gap.
...
**See also:** Edit 3D Properties [dialog] > Appearance of the Store > Gap [rack]
...
**Assignment Value:** You can assign a value of data type any. Specify `void` to use the default ground clearance. Specify `0` to make the lowest shelf rest flat on the floor.
...
**See also:** `_3D.StoreType` [SimTalk], Edit 3D Properties [dialog] > Appearance of the Store > Board Thickness
...
|----------|----------|--------------------|--------------------|
| Center | Bottom | Center (default setting) | Center (default setting) |
| Center | Top | | |
| Left | Bottom | | |
| Left | Top | | |
| Left | Center | | |
...
**Assignment Value:** You can assign a value of data type string. You can specify `"Left"`, `"Center"`, or `"Right"`.
...
**See also:** `_3D.OriginY` [SimTalk], Edit 3D Properties [dialog] > Appearance of the Store > Origin [graphic]
...
**Assignment Value:** You can assign a value of data type string. You can specify `"Top"`, `"Center"`, or `"Bottom"`.
...
**See also:** `_3D.OriginX` [SimTalk], Edit 3D Properties [dialog] > Appearance of the Store > Origin [graphic]
...
**See also:** Edit 3D Properties [dialog] > Appearance of the Store > Material [tab]
...
**Remarks:** When assigning a value to the attribute, we automatically set the material to active (`MaterialActive := true`).

**Note:** You can only access the attribute if the material is active.
...
**Remarks:** You can only access the attribute if the material is active.
